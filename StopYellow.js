...
// @version      0.1
// @description  Block URLs containing "yandex"
// @author       You
// @match        *://*/*
// @grant        none
// ==/UserScript==
...
(function () {
    ...
    // Define an array of keywords to block
    var blockedKeywords = ['yandex', 'bad.news'];

    // Get the current URL
    var currentURL = window.location.href;

    // Check if the current URL contains any blocked keywords
